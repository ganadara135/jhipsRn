  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="orgApp.album.home.createOrEditLabel" data-cy="AlbumCreateUpdateHeading">
            <Translate contentKey="orgApp.album.home.createOrEditLabel">Create or edit a Album</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
          ...
          {loading ? (
            ...
            <AvForm model={isNew ? {} : albumEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                ...
                <AvInput id="album-description" data-cy="description" type="textarea" name="description" />
              </AvGroup>
              <AvGroup>
              ...
              <AvGroup>
                ...
                <AvInput id="album-user" data-cy="user" type="select" className="form-control" name="userId">
                  <option value="" key="0" />
                  {users
