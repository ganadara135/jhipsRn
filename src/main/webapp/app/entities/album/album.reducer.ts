...
export const ACTION_TYPES = {
  ...
  PARTIAL_UPDATE_ALBUM: 'album/PARTIAL_UPDATE_ALBUM',
...
export default (state: AlbumState = initialState, action): AlbumState => {
  switch (action.type) {
    ...
    case REQUEST(ACTION_TYPES.PARTIAL_UPDATE_ALBUM):
      return {
        ...state,
        errorMessage: null,
        updateSuccess: false,
    ...
    case FAILURE(ACTION_TYPES.PARTIAL_UPDATE_ALBUM):
    ...
    case SUCCESS(ACTION_TYPES.PARTIAL_UPDATE_ALBUM):
      return {
        ...state,
        updating: false,
        updateSuccess: true,
...
export const partialUpdate: ICrudPutAction<IAlbum> = entity => async dispatch => {
  const result = await dispatch({
    type: ACTION_TYPES.PARTIAL_UPDATE_ALBUM,
