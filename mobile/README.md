# How to dev
- to install expo modules for avoiding version confliction, 'npx expo install module-name'                                  <br>
- api call(apisauce) on this version(jhi-react-native) doesnt' support useing dynamic id. so need manual setting             <br>
